<template>
  <div class="container my-4">
    ...
    <form @submit.prevent="submitProduct">
      ...
      <nuxt-link class="btn btn-dark ms-2" to="/services">ย้อนกลับ</nuxt-link>
    </form>
  </div>
</template>
...
const fetchCategorys = async () => {
  try {
    ...
    console.log("Fetched categorys:", data.value);
...
const submitProduct = async () => {
  ...
  try {
    const res = await fetch(`${config.public.API_BASE}/services/create`, {
      method: "POST",
